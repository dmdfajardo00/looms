		...
		faq: {
			...
			items: [
				...
				},
				{
					...
					answer:
						"Yes, all recordings are encrypted in transit and at rest. You control who has access to your recordings, and you can delete them anytime. Looms Pro includes additional security features like password protection.",
				},
				{
					question: "Can viewers download my recordings?",
					answer:
						"By default, viewers can only watch recordings in the browser. Looms Pro allows you to control download permissions and add password protection for sensitive content.",
				},
				{
				...
				{
					question: "What happens to my recordings if I upgrade to Looms Pro?",
					answer:
				...
				},
				{
					...
					answer:
						"Basic editing like trimming is available for all recordings. Looms Pro includes advanced editing features and the ability to download recordings for external editing.",
				},
			],
		},
		video: {
