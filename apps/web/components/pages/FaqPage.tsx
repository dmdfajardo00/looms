...
const faqContent: FaqItem[] = [
	...
	},
	{
		...
		answer:
			"Yes! Looms Pro includes a built-in Loom video importer that lets you seamlessly transfer your existing Loom recordings into Cap. Just paste your Loom video links and Cap handles the rest — keeping all your content organized in one place.",
	},
	{
