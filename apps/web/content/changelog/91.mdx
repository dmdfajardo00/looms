...
- **Caption tracks in the timeline** — Loomstions now appear as editable segments directly in the editor timeline. You can drag, trim, split, and rearrange them alongside your other tracks. Per-segment styling overrides, text tools, and presets are available in the sidebar so you can fix transcripts and fine-tune appearance without leaving the editor.
