...
Cap provides analytics for your shared recordings so you can understand who is viewing your content and how your recordings are performing over time. Analytics are available on your Looms dashboard for every recording you have shared.

## Accessing Analytics

To view analytics for a recording:

1. Open your [Looms dashboard](https://cap.so/dashboard).
...
Unique views are tracked using anonymous session identifiers. Cap does not collect personally identifiable information about viewers unless they are signed in with a Looms account.

## Dashboard Overview

Your Looms dashboard provides a high-level view of all your recordings with key metrics visible at a glance:
