...
- **On your dashboard** - Your [Looms dashboard](https://cap.so/dashboard) shows notifications for new comments on your recordings.
...
- **In-app notifications** - Visible on your Looms dashboard.
