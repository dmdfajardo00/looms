...
- Looms AI (for generating descriptions and titles)
...
You can download the latest version of Cap at [Looms/download](https://cap.so/download). Whether you're creating tutorials, presentations, or just want to share a quick idea, we hope Cap v0.3.0 makes the process smooth and enjoyable.
